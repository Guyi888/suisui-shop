	...
	<div class="wrapper">';
            ...
            <form action="./list.php" method="GET" class="form-inline">
                <div class="form-group">
                    ...
                    <a href="#" data-toggle="modal" data-target="#search2" id="search2" class="btn btn-success"><i
                                class="fa fa-exclamation-circle"></i>&nbsp;订单状态说明</a>
                </div>
            </form>
        </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code == 0) {
                    ...
                    if (data.complain) {
                        item += '<tr><td class="info" class="orderTitle">订单操作</td><td class="orderContent"><a href="./workorder.php?my=add&orderid=' + id + '&skey=' + skey + '" target="_blank" onclick="return checklogin(' + data.islogin + ')" class="btn btn-block btn-default">投诉订单</a></td><td class="orderContent"><a href="#" onclick="return orderRefund(' + data.islogin + ',' + id + ')" class="btn btn-block btn-danger">申请退款</a></td></tr>';
                    }
