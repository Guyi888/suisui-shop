...
function getPoint() {
	...
	if($("#inputname2").html().indexOf('说说ID')>=0||$("#inputname2").attr('gettype')=='ssid'){
		$('#inputvalue2').attr("disabled", true);
		$('#inputvalue2').attr("placeholder", "填写QQ账号后点击→");
	}else if($("#inputname").html().indexOf('作品ID')>=0||$("#inputname").html().indexOf('作品ＩＤ')>=0||$("#inputname").html().indexOf('帖子ID')>=0||$("#inputname").html().indexOf('用户ID')>=0||$("#inputname").html().indexOf('用户ＩＤ')>=0||inputnametype=='shareid'){
		$('#inputvalue').attr("placeholder", "在此输入分享链接 可自动获取");
		$('#inputname').attr("gettype", "shareid");
		if($("#inputname2").html().indexOf('作品ID')>=0||$("#inputname2").html().indexOf('作品ＩＤ')>=0||$("#inputname2").attr('gettype')=='zpid'){
			$('#inputvalue2').attr("placeholder", "填写作品链接后点击→");
			$("#inputvalue2").attr('disabled', true);
		}
	}else if($("#inputname").html().indexOf('作品链接')>=0||$("#inputname").html().indexOf('视频链接')>=0||$("#inputname").html().indexOf('分享链接')>=0||inputnametype=='shareurl'){
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.code == 0) {
          ...
          if (typeof data.songid2 != "undefined" && $("#inputvalue2").length > 0)
...
function checkInput() {
	...
	// 自动检测作品链接类型并处理
	else if($("#inputname").html().indexOf('作品链接')>=0 || $("#inputname").html().indexOf('视频链接')>=0 || $("#inputname").html().indexOf('分享链接')>=0){
		if($("#inputvalue").val()!='' && $("#inputvalue").val().indexOf('http')>=0){
			getsharelink();
		}
	}
