...
$("#cid").change(function () {
	...
	$("#submit_buy").click(function(){
		...
		$.ajax({
			...
			data : {tid:tid,inputvalues:inputvalues,hashsalt:hashsalt},
			dataType : 'json',
			success : function(data) {
				layer.close(ii);
				if(data.code == 0){
