...
function getPoint() {
	...
	if(close == 1){
		$('#submit_cart_shop').val('维护中');
		$('#submit_cart_shop').html('维护中');
		document.getElementById("submit_cart_shop").id = 'submit_cart_shopno';
		$('#submit_buy').val('停止下单');
		$('#submit_buy').html('停止下单');
		document.getElementById("submit_buy").id = 'submit_buyno';
