...
<label><input name="chkAll1" type="checkbox" id="chkAll1" onClick="checkAll()" value="checkbox">全选</label>&nbsp;
...
function display_shoptype($type, $shequ = 0, $tid = 0)
{
	...
	if ($type == 1 || $type == 2) {
		...
		return "<a href=\"fakakms.php?my=add&tid=" . $tid . "\" class=\"btn-success btn-xs\">发卡</a>";
	} else {
