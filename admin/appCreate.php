...
<form onsubmit="return saveSetting(this)" method="post" class="form-horizontal form-bordered" role="form">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-9"><div class="input-group"><input type="text" name="appcreate_key" value="<?php echo $conf['appcreate_key']; ?>" class="form-control"/><span class="input-group-btn"><a href="https://app.51zhihuigu.com/" class="btn btn-default" target="_blank" rel="noreferrer">获取密钥</a></span></div></div>
	</div>
	<div class="form-group">
