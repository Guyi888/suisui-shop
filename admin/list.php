...
.orderList tbody tr>td:nth-child(6){max-width:100px;min-width:80px;text-align:center}
.orderList tbody tr>td:nth-child(7){max-width:100px;min-width:50px;text-align:center}
.orderList tbody tr>td:nth-child(8){min-width:150px;text-align:center}
.orderList tbody tr>td:nth-child(9),.orderList tbody tr>td:nth-child(10){min-width:70px;text-align:center}
.orderList tbody tr>td:nth-child(11){min-width:150px;text-align:center}
.layui-layer-content{padding: 10px;}
.dates{max-width: 120px;}
.input-group-addon{min-width: unset;}

/* 表格中select元素的专门样式 */
table.orderList td select.form-control {
    width: 100% !important;
