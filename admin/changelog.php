            ...
            <div class="timeline-list">
                <div class="alert alert-success">
                    ...
                    <ul>
                        ...
                        <li>修复专业版分站下面再开下级时，下级的下级价格没有完整继承上级专业站加价模板的问题。</li>
                        <li>修复普通分站设置密价后，后台可见密价但实际拿货价仍可能被上级价格覆盖的问题。</li>
                        <li>多级分站分润改为逐级拆分差价，订单流水中的提成金额与每层实际拿货价保持一致。</li>
                        <li>程序缓存版本更新到 <code>2026052505</code>，本版本不包含数据库结构变更。</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                ...
                <div class="alert alert-success">
                    ...
                    <ul>
                        ...
                        <li>修复专业版分站设置密价后，后台密价列表把模板计算后的下级专业价误显示为“当前分站成本价”的问题。</li>
                        <li>后台批量调整密价改为以当前站长真实拿货成本为基准，不再误用模板后的下级专业价。</li>
                        <li>分站商品保存时，下级专业价最低校验改为参考当前站长真实成本，密价仍作为当前站长成本基准。</li>
                        <li>价格模板链路保持不变：下级专业价、下级普通价和最终销售价继续在当前成本基准上递进计算。</li>
                        <li>程序缓存版本更新到 <code>2026052501</code>，本版本不包含数据库结构变更。</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                    <h4><i class="fa fa-check-circle"></i> v1.0.2.27 / 2026-05-24 商品控价与首页推荐商品</h4>
                    <ul>
                        <li>后台商品编辑页新增“控价金额（最低限价）”，可限制下级分站及更下级站点的最终前端售价。</li>
                        <li>控价只约束最终销售价，不改变对接成本、密价成本、订单扣款和分润成本口径。</li>
                        <li>修复密价与分站模板优先级：密价作为当前站长拿货成本基准，模板继续计算下级专业价、普通价和销售价。</li>
                        <li>首页新增折叠式推荐商品入口，展开后支持按自定义分类标签切换推荐商品。</li>
                        <li>推荐商品后台新增分类标签字段；推荐接口兼容空表环境，不再因未创建推荐表返回 500。</li>
                        <li>程序缓存版本更新到 <code>2026052417</code>，首次运行会自动补齐控价和推荐分类字段。</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                ...
                <div class="alert alert-success">
                    ...
                    <ul>
                        ...
                        <li>订单成本改为按当前站点实际拿货价写入，用户中心今日收益、收益图和收支明细与提成流水保持同一口径。</li>
                        <li>购物车订单补齐分站成本写入和提成流水；远程对接商品不再覆盖分站订单的站点成本。</li>
                        <li>专业版分站的下级不再继续开通子级分站，分站加价模板只影响自己的下级售价。</li>
                        <li>卡密订单保留底部统一“复制卡密信息”按钮，去除卡密框内重复复制按钮。</li>
                        <li>程序缓存版本更新到 <code>2026052413</code>，本版本不包含数据库结构变更，历史订单不会自动补差。</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                    <h4><i class="fa fa-check-circle"></i> v1.0.2.24 / 2026-05-23 上下级分站真实成本分润修复</h4>
                    <ul>
                        <li>修复普通分站下单时，上级专业站收益使用模板底价而不是订单实际成本，导致上级专业站收益偏低的问题。</li>
                        <li>新订单会优先按订单实际提卡价计算上级专业站收益；未传入实际成本时继续沿用原有模板成本逻辑。</li>
                        <li>专业版分站直接销售时，收益计算也会优先参考订单实际成本。</li>
                        <li>新订单提成流水备注补充成交价、拿货价或实际成本，方便运营人员核对分润链路。</li>
                        <li>程序缓存版本更新到 <code>2026052313</code>，本版本不包含数据库结构变更，历史订单提成流水不自动补差。</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                ...
                <div class="alert alert-success">
                    ...
                    <ul>
                        ...
                        <li>下方新增“所属明细”面板，会按当前日期、ZID 和关键词范围展示对应订单、支付、余额流水或提现记录。</li>
                        <li>统计卡片改为更紧凑的后台网格样式，增加选中态和悬停反馈，减少大块空白。</li>
                        <li>分页链接会保留当前明细类型，翻页时不会丢失卡片筛选状态。</li>
                        <li>程序缓存版本更新到 <code>2026052305</code>，本版本不包含数据库结构变更。</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                    <h4><i class="fa fa-check-circle"></i> v1.0.2.16 / 2026-05-23 后台财务统计口径细化</h4>
                    <ul>
                        <li>后台首页“今日收益”调整为“今日主站收入”，按订单流水、成本、分站提成和站点福利统一计算。</li>
                        <li>利润统计新增主站收入、充值入账、福利赠送、退款明细、站点余额和分站提成等拆分数据。</li>
                        <li>收支明细新增按流水类型拆分的统计表，方便查看充值、加款、提成、赠送、返利、退款、消费、扣除、提现等分类金额。</li>
                        <li>修复退款负数流水仍按收入方向显示的问题，退款扣回提成现在会按支出口径展示。</li>
                        <li>支付通道统计只展示商品支付流水，不再把在线充值和供货商充值混入商品交易额。</li>
                        <li>程序缓存版本更新到 <code>2026052303</code>，本版本不包含数据库结构变更。</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                    <h4><i class="fa fa-check-circle"></i> v1.0.2.15 / 2026-05-23 &#21516;&#27493;&#21830;&#21697;&#26469;&#28304;&#20445;&#25252;&#19982;&#20215;&#26684;&#23637;&#31034;&#20462;&#22797;</h4>
                    <ul>
                        <li>&#20462;&#22797;&#33258;&#21160;&#21516;&#27493;&#24320;&#21551;&#21024;&#38500;&#35268;&#21017;&#26102;&#65292;&#21487;&#33021;&#35823;&#21024;&#21518;&#21488;&#25163;&#21160;&#26032;&#22686;&#21830;&#21697;&#30340;&#38382;&#39064;&#12290;</li>
                        <li>&#26032;&#22686; <code>pre_sync_goods_map</code> &#21516;&#27493;&#26469;&#28304;&#26144;&#23556;&#34920;&#65292;&#21482;&#23545;&#33258;&#21160;&#21516;&#27493;&#27969;&#31243;&#30830;&#35748;&#36807;&#26469;&#28304;&#30340;&#21830;&#21697;&#25191;&#34892;&#19978;&#28216;&#32570;&#22833;&#21024;&#38500;&#25110;&#19979;&#26550;&#12290;</li>
                        <li>&#21516;&#27493;&#26032;&#22686;&#25110;&#26356;&#26032;&#21830;&#21697;&#26102;&#20250;&#32500;&#25252;&#26469;&#28304;&#26144;&#23556;&#65292;&#21024;&#38500;&#21516;&#27493;&#21830;&#21697;&#26102;&#20250;&#21516;&#27493;&#28165;&#29702;&#26144;&#23556;&#12290;</li>
                        <li>&#20462;&#22797;&#21518;&#21488;&#21830;&#21697;&#21015;&#34920;&#21644;&#20215;&#26684;&#24377;&#31383;&#22312;&#20351;&#29992;&#21152;&#20215;&#27169;&#26495;&#26102;&#65292;&#23637;&#31034;&#20215;&#26684;&#19982;&#23454;&#38469;&#29983;&#25928;&#20215;&#26684;&#19981;&#19968;&#33268;&#30340;&#38382;&#39064;&#12290;</li>
                        <li>&#20462;&#22797;&#19987;&#19994;&#29256;&#20998;&#31449;&#21033;&#28070;&#35745;&#31639;&#22312;&#23384;&#22312;&#31449;&#38271;&#33258;&#35774;&#25104;&#26412;&#20215;&#26102;&#30340;&#25104;&#26412;&#20248;&#20808;&#32423;&#12290;</li>
                        <li>&#31243;&#24207;&#32531;&#23384;&#29256;&#26412;&#26356;&#26032;&#21040; <code>2026052302</code>&#65292;&#39318;&#27425;&#36816;&#34892;&#21516;&#27493;&#20250;&#33258;&#21160;&#21019;&#24314;&#21516;&#27493;&#26469;&#28304;&#26144;&#23556;&#34920;&#12290;</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                    <h4><i class="fa fa-check-circle"></i> v1.0.2.14 / 2026-05-22 &#21516;&#31995;&#32479;&#21830;&#21697;&#38480;&#36141;&#23383;&#27573;&#21516;&#27493;&#20462;&#22797;</h4>
                    <ul>
                        <li>&#20462;&#22797;&#21516;&#31995;&#32479; <code>goodslist</code> &#25509;&#21475;&#26410;&#36755;&#20986; <code>goods_type</code>&#12289;<code>multi</code>&#12289;<code>min/max</code> &#31561;&#36141;&#20080;&#38480;&#21046;&#23383;&#27573;&#65292;&#23548;&#33268;&#19979;&#28216;&#21830;&#21697;&#34987;&#38169;&#35823;&#21516;&#27493;&#25104;&#8220;&#38480;&#36141; 1 &#20221;&#8221;&#30340;&#38382;&#39064;&#12290;</li>
                        <li>&#20462;&#22797;&#21516;&#31995;&#32479;&#23545;&#25509;&#25554;&#20214;&#35835;&#21462;&#19978;&#28216;&#21830;&#21697;&#21015;&#34920;&#26102;&#20002;&#24323; <code>goods_type</code>&#12289;<code>multi</code>&#12289;<code>repeat</code>&#12289;<code>validate</code> &#21644;&#25209;&#21457;&#20215;&#31561;&#23383;&#27573;&#30340;&#38382;&#39064;&#12290;</li>
                        <li>&#33258;&#21160;&#21516;&#27493;&#24050;&#26377;&#21830;&#21697;&#26102;&#20250;&#23545;&#27604;&#24182;&#26356;&#26032; <code>goods_type</code> &#19982; <code>multi</code>&#65292;&#21382;&#21490;&#38169;&#35823;&#21830;&#21697;&#21487;&#36890;&#36807;&#21518;&#32493;&#21516;&#27493;&#20462;&#27491;&#12290;</li>
                        <li>&#21457;&#21345;&#23646;&#24615;&#32479;&#19968;&#35782;&#21035;&#65306;<code>is_curl=4</code> &#25110; <code>goods_type=1</code> &#37117;&#20250;&#25353;&#21457;&#21345;&#21830;&#21697;&#21521;&#19979;&#28216;&#36755;&#20986;&#12290;</li>
                        <li>&#31243;&#24207;&#32531;&#23384;&#29256;&#26412;&#26356;&#26032;&#21040; <code>2026052215</code>&#65292;&#26412;&#29256;&#26412;&#19981;&#21253;&#21547;&#25968;&#25454;&#24211;&#32467;&#26500;&#21464;&#26356;&#12290;</li>
                    </ul>
                </div>
                <div class="alert alert-success">
                    <h4><i class="fa fa-check-circle"></i> v1.0.2.13 / 2026-05-22 &#23545;&#25509;&#35746;&#21333;&#21345;&#23494;&#21516;&#27493;&#19982;&#25163;&#21160;&#21457;&#21345;&#20462;&#22797;</h4>
                    <ul>
                        <li>&#20462;&#22797;&#20998;&#31449;&#23494;&#20215;&#35774;&#32622;&#21518;&#65292;&#37096;&#20998;&#21830;&#21697;&#20173;&#26410;&#25353;&#23494;&#20215;&#20248;&#20808;&#29983;&#25928;&#30340;&#38382;&#39064;&#12290;</li>
                        <li>&#20462;&#22797;&#23545;&#25509;&#19978;&#28216;&#24050;&#36820;&#22238;&#23436;&#25104;&#20294;&#26410;&#36820;&#22238;&#21345;&#23494;&#26102;&#65292;&#26412;&#22320;&#35746;&#21333;&#34987;&#38169;&#35823;&#26631;&#35760;&#20026;&#25104;&#21151;&#30340;&#38382;&#39064;&#12290;</li>
                        <li>&#20462;&#22797;&#19978;&#28216;&#21518;&#32493;&#34917;&#21457;&#21345;&#23494;&#21518;&#65292;&#26412;&#22320;&#21069;&#21488;&#26597;&#35810;&#21644; API &#26597;&#35810;&#26080;&#27861;&#21516;&#27493;&#21345;&#23494;&#30340;&#38382;&#39064;&#12290;</li>
                        <li>&#21518;&#21488;&#35746;&#21333;&#21015;&#34920;&#21644;&#35746;&#21333;&#35814;&#24773;&#26032;&#22686;&#8220;&#25163;&#21160;&#21457;&#21345;&#8221;&#20837;&#21475;&#65292;&#25903;&#25345;&#19978;&#28216;&#22833;&#36133;&#19988;&#26412;&#22320;&#26080;&#21345;&#23494;&#26102;&#30001;&#31649;&#29702;&#21592;&#24405;&#20837;&#21345;&#23494;&#23436;&#25104;&#21457;&#36135;&#12290;</li>
                        <li>&#20462;&#22797;&#20215;&#26684;&#30417;&#25511;&#8220;&#31435;&#21363;&#21516;&#27493;&#19968;&#27425;&#20215;&#26684;&#8221;&#21482;&#26174;&#31034;&#40657;&#33394;&#36974;&#32617;&#30340;&#38382;&#39064;&#65292;&#24377;&#31383;&#25913;&#20026; Layer &#23637;&#31034;&#24182;&#36866;&#37197;&#31227;&#21160;&#31471;&#12290;</li>
                        <li>&#31243;&#24207;&#32531;&#23384;&#29256;&#26412;&#26356;&#26032;&#21040; <code>2026052214</code>&#65292;&#26412;&#29256;&#26412;&#19981;&#21253;&#21547;&#25968;&#25454;&#24211;&#32467;&#26500;&#21464;&#26356;&#12290;</li>
                    </ul>
                </div>
                <div class="alert alert-success">
