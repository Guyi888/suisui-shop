                            ...
                            const html = data.data.map(item => {
                                ...
                                if(item.isfaka == 1) {
                                    ...
                                    if (count === undefined) {
                                        ...
                                        // 根据配置的库存显示方式显示库存信息
                                        if(typeof agodn_stock_display !== 'undefined' && agodn_stock_display == 1){
                                            // 模糊库存范围显示
                                            if(count >= 1000){
                                                stockText = '库存充足';
                                            } else if(count >= 500){
                                    ...
                                    // 根据配置的库存显示方式显示库存信息
                                    if(typeof agodn_stock_display !== 'undefined' && agodn_stock_display == 1 && item.stock !== null){
                                        // 模糊库存范围显示
                                        if(item.stock >= 1000){
                                            stockText = '库存充足';
