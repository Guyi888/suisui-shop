                        ...
                        <div class="fui-searchbar bar">
                            <div class="searchbar center searchbar-active" style="padding-right:2.5rem">
                                ...
                                <div class="search-input" style="border: 0px;padding-left:0px;padding-right:0px;">
                                    ...
                                    <input type="text" class="search" value="<?php echo htmlspecialchars(trim(daddslashes($_GET['kw'])));?>" name="kw" placeholder="输入商品关键字..." id="kw">
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
// 模板默认配置
var goods_list_default_style = '<?php echo isset($conf["goods_list_default_style"]) ? $conf["goods_list_default_style"] : "grid"; ?>';
</script>
