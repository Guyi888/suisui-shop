...
<head>
    ...
    <?php if($conf['favicon']){?><link rel="icon" href="<?php echo $conf['favicon'] ?>" type="image/x-icon" /><link rel="shortcut icon" href="<?php echo $conf['favicon'] ?>" type="image/x-icon" /><?php }else{?><link rel="icon" href="assets/img/favicon/favicon.ico" type="image/x-icon" /><link rel="shortcut icon" href="assets/img/favicon/favicon.ico" type="image/x-icon" /><?php }?>
...
<script src="<?php echo $cdnserver ?>assets/store/js/image-optimizer.js"></script>
<script>
