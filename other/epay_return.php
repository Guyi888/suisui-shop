...
if($verify_result && ($conf['alipay_api']==2 || $conf['qqpay_api']==2 || $conf['wxpay_api']==2 || $conf['qqpay_api']==8 || $conf['wxpay_api']==8 || $conf['wxpay_api']==9 || $conf['alipay_api']==10 || $conf['qqpay_api']==10 || $conf['wxpay_api']==10) && !empty($pay_config['pid']) && !empty($pay_config['key'])) {
