...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-4 center-block " style="float: none;">
    <br />
        ...
        <div class="panel panel-default">
            <div class="panel-heading" <?php if($conf['background_image_enable'] == 1 && $conf['background_type'] == 'image'){ echo 'style="background-image: url(/assets/img/bj.png);background-size: 100% 100%;"'; } ?>>
